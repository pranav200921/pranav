function showDetails(itemId) {
    ...
    const itemData = [
        { id: 1, title: 'Auto 1', description: 'Details of Auto 1 , Waste Bank is a place for sorting and collecting waste that can be recycled and / or reused that has economic value.' },
